...
.api-footer{max-width:none;margin-top:var(--atlas-space-9);padding:var(--atlas-space-6) 0 var(--atlas-space-8);display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-areas:"identity escape" "context context" "evidence evidence";align-items:start;gap:var(--atlas-space-4) var(--atlas-space-6);border-top:1px solid var(--border);color:var(--text-faint);font:400 var(--atlas-type-meta)/1.6 var(--mono)}.api-footer .atlas-footer__identity{grid-area:identity;min-width:0;color:var(--text)}.api-footer .atlas-footer__identity strong,.api-footer .atlas-footer__identity span{display:block}.api-footer .atlas-footer__identity strong{font-weight:500;letter-spacing:.05em;text-transform:uppercase}.api-footer .atlas-footer__identity span{margin-top:var(--atlas-space-1);color:var(--text-faint)}.api-footer .atlas-footer__context{grid-area:context}.api-footer .atlas-footer__evidence{grid-area:evidence}.api-footer .atlas-footer__escape{grid-area:escape;justify-self:end}.api-footer .atlas-footer__context,.api-footer .atlas-footer__evidence,.api-footer .atlas-footer__escape{display:flex;flex-wrap:wrap;align-items:center;gap:var(--atlas-space-2) var(--atlas-space-4)}.api-footer a{min-height:var(--atlas-touch-min);display:inline-flex;align-items:center;color:var(--text-dim)}.api-footer a:hover{color:var(--text)}
