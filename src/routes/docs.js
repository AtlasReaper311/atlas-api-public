...
.api-footer{max-width:none;margin-top:var(--atlas-space-7);padding:var(--atlas-space-5) 0;display:grid;grid-template-columns:minmax(0,1.25fr) minmax(0,.75fr);grid-template-areas:"identity escape" "context evidence";align-items:center;column-gap:var(--atlas-space-6);row-gap:var(--atlas-space-1);border-top:1px solid var(--border-hi);color:var(--text-faint);font:400 var(--atlas-type-meta)/1.6 var(--mono)}.api-footer .atlas-footer__identity{grid-area:identity;min-width:0;display:flex;flex-wrap:wrap;align-items:baseline;gap:var(--atlas-space-1) var(--atlas-space-3);color:var(--text)}.api-footer .atlas-footer__identity strong,.api-footer .atlas-footer__identity span{display:inline}.api-footer .atlas-footer__identity strong{font-weight:500;letter-spacing:.05em;text-transform:uppercase}.api-footer .atlas-footer__identity span{margin-top:0;color:var(--text-faint)}.api-footer .atlas-footer__context{grid-area:context}.api-footer .atlas-footer__evidence{grid-area:evidence;justify-self:end;justify-content:flex-end}.api-footer .atlas-footer__escape{grid-area:escape;justify-self:end}.api-footer .atlas-footer__context,.api-footer .atlas-footer__evidence,.api-footer .atlas-footer__escape{min-width:0;display:flex;flex-wrap:wrap;align-items:center;gap:0 var(--atlas-space-4)}.api-footer a{min-width:var(--atlas-touch-min);min-height:var(--atlas-touch-min);display:inline-flex;align-items:center;color:var(--text-dim)}.api-footer a:hover{color:var(--text)}
...
<footer class="atlas-footer atlas-footer--product api-footer" aria-label="Public API product footer">
  ...
  <div class="atlas-footer__context"><a href="/v1/openapi.json">OpenAPI contract</a><a href="https://atlas-systems.uk/systems/">Systems directory</a></div>
