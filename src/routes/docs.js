...
.api-global-header.atlas-global-header{display:block;padding:0;min-height:var(--nav-h);background:rgba(10,10,15,.96)}
.api-global-header .atlas-header__inner{width:min(calc(100% - 48px),1280px);min-height:var(--nav-h);margin-inline:auto;display:grid;grid-template-columns:minmax(230px,1fr) auto minmax(230px,1fr);align-items:center;gap:24px}
.api-global-header .atlas-global-header__identity{display:flex;align-items:center;gap:12px;min-width:0}
.wordmark{flex:none;min-height:44px;display:inline-flex;align-items:center;color:var(--text);font-size:13px;font-weight:500;letter-spacing:.12em;text-decoration:none;text-transform:uppercase;white-space:nowrap}.wordmark span{color:var(--accent)}
.api-global-header .atlas-global-header__nav{gap:24px}
.api-global-header .atlas-global-header__link{padding-inline:12px;font-size:12px;letter-spacing:.06em;text-transform:uppercase}
.api-global-header .atlas-status.estate-status,.estate-status{min-height:44px;padding:0 10px;border-radius:var(--atlas-radius-md);background:var(--bg-1);color:var(--text-dim);font:10px/1 var(--mono);letter-spacing:.08em;gap:7px;text-decoration:none;white-space:nowrap}.estate-status-dot{width:7px;height:7px;flex:0 0 7px;border-radius:50%;background:var(--atlas-unknown)}.estate-status[data-state="operational"] .estate-status-dot{background:var(--green);box-shadow:0 0 0 3px rgba(74,222,128,.12)}.estate-status[data-state="degraded"] .estate-status-dot,.estate-status[data-state="checking"] .estate-status-dot{background:var(--accent);box-shadow:0 0 0 3px rgba(245,166,35,.12)}.estate-status[data-state="unavailable"] .estate-status-dot{background:var(--red);box-shadow:0 0 0 3px rgba(226,75,74,.12)}
.search-trigger{display:inline-flex;min-height:44px;align-items:center;gap:8px;padding:0 14px;border:1px solid var(--border);border-radius:var(--atlas-radius-md);background:var(--bg-1);color:var(--text-dim);font:500 11px/1 var(--mono);letter-spacing:.06em;text-transform:uppercase;cursor:pointer}.search-trigger:hover,.search-trigger:focus-visible{border-color:var(--border-hi);color:var(--text)}.search-trigger svg{width:15px;height:15px;fill:none;stroke:currentColor;stroke-width:1.5}.search-trigger kbd{color:var(--text-faint);font:inherit;font-size:var(--atlas-type-tiny)}
.api-product-strip{display:grid;grid-template-columns:auto minmax(0,1fr) auto;min-height:44px;padding-inline:max(24px,calc((100% - 1280px)/2));color:var(--text-dim);font:500 var(--atlas-type-meta)/1.4 var(--mono);letter-spacing:.08em;text-transform:uppercase}.api-product-strip strong{color:var(--accent);font-weight:500}.api-product-strip span:last-child{color:var(--text-faint)}
...
.api-footer{max-width:none;margin-top:var(--atlas-space-7);padding:var(--atlas-space-4) 0;display:flex;flex-wrap:wrap;align-items:center;gap:0 var(--atlas-space-4);border-top:1px solid var(--border-hi);color:var(--text-faint);font:400 var(--atlas-type-meta)/1.5 var(--mono)}.api-footer .atlas-footer__identity{min-width:min(100%,220px);flex:1 1 260px;display:grid;gap:2px;color:var(--text)}.api-footer .atlas-footer__identity strong,.api-footer .atlas-footer__identity span{display:block}.api-footer .atlas-footer__identity strong{font-weight:500;letter-spacing:.06em;line-height:1.35;text-transform:uppercase}.api-footer .atlas-footer__identity span{color:var(--text-faint);line-height:1.45}.api-footer .atlas-footer__context,.api-footer .atlas-footer__evidence,.api-footer .atlas-footer__escape{min-width:0;display:flex;flex:0 0 auto;flex-wrap:nowrap;align-items:center;gap:0 var(--atlas-space-3);white-space:nowrap}.api-footer .atlas-footer__evidence,.api-footer .atlas-footer__escape{border-left:1px solid var(--border);padding-left:var(--atlas-space-4)}.api-footer a{min-width:var(--atlas-touch-min);min-height:var(--atlas-touch-min);display:inline-flex;align-items:center;color:var(--text-dim);text-decoration:underline;text-decoration-color:currentColor;text-decoration-thickness:from-font;text-underline-offset:.22em}.api-footer a:hover{color:var(--text)}
...
.api-bottom-nav a{letter-spacing:0}
:where(a,button,input,[tabindex]):focus-visible{outline:2px solid var(--accent);outline-offset:3px}
@media(max-width:767px){.api-global-header.atlas-global-header{position:sticky;padding:0}.api-global-header .atlas-header__inner{width:min(calc(100% - 32px),1280px);grid-template-columns:minmax(0,1fr) auto;gap:12px}.api-global-header .atlas-global-header__identity{gap:var(--atlas-space-2)}.search-trigger{min-width:44px;min-height:44px;justify-content:center;padding:0}.search-trigger span,.search-trigger kbd{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}.api-product-strip{grid-template-columns:1fr auto;padding-inline:16px}.api-product-strip span:nth-child(2){grid-column:1/-1;grid-row:2}.api-page-intro{padding-top:var(--atlas-space-7)}main{padding-inline:var(--atlas-space-4)}.api-footer{flex-direction:column;flex-wrap:nowrap;align-items:flex-start;gap:0;padding-bottom:calc(var(--atlas-space-8) + env(safe-area-inset-bottom))}.api-footer .atlas-footer__identity{width:100%;min-width:0;flex:0 0 auto;margin-bottom:var(--atlas-space-1)}.api-footer .atlas-footer__context,.api-footer .atlas-footer__evidence,.api-footer .atlas-footer__escape{width:100%;flex:0 0 auto;flex-wrap:wrap;gap:0 var(--atlas-space-3);border-left:0;padding-left:0;white-space:normal}}
@media(max-width:420px){.estate-status{width:32px;justify-content:center;padding:0}.estate-status [data-estate-status-label]{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}}
`;
...
<footer class="atlas-footer atlas-footer--product api-footer" aria-label="Public API product footer">
  ...
  <div class="atlas-footer__context"><a href="/v1/openapi.json">OpenAPI contract</a></div>
  <div class="atlas-footer__evidence"><a href="https://status.atlas-systems.uk/">Estate status</a><a href="https://github.com/AtlasReaper311/atlas-api-public">Source</a></div>
